(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 34424))
 (memory $0 1)
 ...
 (data $11 (i32.const 1632) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00A")
 ...
 (func $export:assembly/index/_toBase64 (param $0 i32) (param $1 i32) (result i32)
  ...
  block $folding-inner1
   ...
   local.get $1
   i32.store offset=4
   block $__inlined_func$assembly/index/_toBase64$2 (result i32)
    global.get $~lib/memory/__stack_pointer
    i32.const 8
    i32.sub
    global.set $~lib/memory/__stack_pointer
    block $folding-inner0
     ...
     global.set $~lib/memory/__stack_pointer
     local.get $0
     br $__inlined_func$assembly/index/_toBase64$2
    end
    br $folding-inner1
   end
   local.set $0
